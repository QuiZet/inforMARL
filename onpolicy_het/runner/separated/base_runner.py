...
from onpolicy_het.utils.separated_buffer import SeparatedReplayBuffer
...
class Runner(object):
    def __init__(self, config):
        ...
        self.buffer = []
        for agent_id in range(self.num_agents):
            print(f'agent_id[{agent_id}] buffer/trainer allocation and initialization')
            # algorithm
        ...
        print(f'self.trainer:{len(self.trainer)}')
