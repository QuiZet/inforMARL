...
from onpolicy_het.utils.util import (
    check,
...
class SeparatedReplayBuffer(object):
    def __init__(self, args, obs_space, share_obs_space, act_space):
        ...
        #print(f'self.obs:{self.obs.shape}')
    ...
    def chooseinsert(
        ...
        #print('SeparatedReplayBuffer::chooseinsert')
    ...
    def after_update(self):
        #print('SeparatedReplayBuffer::after_update')
    ...
    def chooseafter_update(self):
        #print('SeparatedReplayBuffer::chooseafter_update')
        self.rnn_states[0] = self.rnn_states[-1].copy()
        self.rnn_states_critic[0] = self.rnn_states_critic[-1].copy()
        self.masks[0] = self.masks[-1].copy()
        self.bad_masks[0] = self.bad_masks[-1].copy()
    ...
    def compute_returns(self, next_value, value_normalizer=None):
        #print('SeparatedReplayBuffer::compute_returns')
    ...
    def feed_forward_generator(
        ...
        #print('SeparatedReplayBuffer::feed_forward_generator')
    ...
    def naive_recurrent_generator(self, advantages, num_mini_batch):
        #print('SeparatedReplayBuffer::naive_recurrent_generator')
    ...
    def recurrent_generator(self, advantages, num_mini_batch, data_chunk_length):
        #print('SeparatedReplayBuffer::recurrent_generator')
        episode_length, n_rollout_threads = self.rewards.shape[0:2]
        batch_size = n_rollout_threads * episode_length
