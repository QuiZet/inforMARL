...
from onpolicy_het.utils.util import get_shape_from_obs_space, get_shape_from_act_space
...
class SharedReplayBuffer(object):
    ...
    def insert(
        ...
        self.rewards[self.step] = rewards.copy() if self.rewards[self.step].shape == rewards.shape else np.expand_dims(rewards, axis=2) # rewards.copy()
