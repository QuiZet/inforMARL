...
from multiagent_het.core import World, Agent
from multiagent_het.multi_discrete import MultiDiscrete
...
class MultiAgentBaseEnv(gym.Env):
    ...
    def __init__(
        ...
        self.current_step = 0
        # add a missing variable that does not exist in the current environment
        if hasattr(self.world, "current_time_step") is False:
            self.world.current_time_step = 0

        self.agents = self.world.policy_agents
        print(f'MultiAgentBaseEnv #self.agents:{len(self.agents)}')
...
class MultiAgentPPOEnv(MultiAgentBaseEnv):
    ...
    def step(self, action_n: List) -> Tuple[List, List, List, List]:
        ...
        #else: # CHECKCHECKCHECK ADDED THIS PART
        #    reward_n = [
        #        [reward]
        #    ] * self.n
