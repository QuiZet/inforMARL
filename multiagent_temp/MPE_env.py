...
from multiagent_temp.custom_scenarios import load
...
def MPEEnv(args: argparse.Namespace):
    ...
    if args.algorithm_name in ["mappo", "rmappo"]:
        from multiagent_temp.environment import MultiAgentPPOEnv as MultiAgentEnv
    else:
        from multiagent_temp.environment import MultiAgentOffPolicyEnv as MultiAgentEnv
    env = MultiAgentEnv(
        world=world,
...
def GraphMPEEnv(args):
    ...
    # create world
    world = scenario.make_world(args=args)
    from multiagent_temp.environment import MultiAgentGraphEnv
...
def GPGMPEEnv(args):
    ...
    # create world
    world = scenario.make_world(args=args)
    from multiagent_temp.environment import MultiAgentGPGEnv
...
def CADRLMPEEnv(args, phase):
    ...
    # create world
    world = scenario.make_world(args=args)
    from multiagent_temp.environment import MultiAgentCADRLEnv
...
def AttentionMPEEnv(args):
    ...
    # create world
    world = scenario.make_world(args=args)
    from multiagent_temp.environment import MultiAgentAttentionEnv
...
def DGNMPEEnv(args):
    ...
    # create world
    world = scenario.make_world(args=args)
    from multiagent_temp.environment import MultiAgentDGNEnv, MultiAgentDGN_ATOCEnv
...
def make_parallel_env(args: argparse.Namespace):
    ...
    if args.env_type == "shared_obs":
        from multiagent_temp.env_wrappers import ShareDummyVecEnv as DummyVecEnv
        from multiagent_temp.env_wrappers import ShareSubprocVecEnv as SubprocVecEnv
    else:
        from multiagent_temp.env_wrappers import DummyVecEnv, SubprocVecEnv
